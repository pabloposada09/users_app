...
AppConfiguration _appConfigurationDeserialize(
  ...
  final object = AppConfiguration(
    ...
    isDarkMode: reader.readBool(offsets[1]),
    isarId: id,
  );
  return object;
}
...
extension AppConfigurationQueryWhereSort
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterWhere> anyIsarId() {
...
extension AppConfigurationQuerySortBy
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterSortBy> sortByColor() {
    return QueryBuilder.apply(this, (query) {
...
extension AppConfigurationQuerySortThenBy
  ...
  QueryBuilder<AppConfiguration, AppConfiguration, QAfterSortBy> thenByColor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'color', Sort.asc);
    });
  }
...
extension AppConfigurationQueryProperty
  ...
  QueryBuilder<AppConfiguration, int, QQueryOperations> isarIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isarId');
    });
  }

  QueryBuilder<AppConfiguration, int, QQueryOperations> colorProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'color');
    });
  }

  QueryBuilder<AppConfiguration, bool, QQueryOperations> isDarkModeProperty() {
    return QueryBuilder.apply(this, (query) {
